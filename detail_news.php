                        ...
                        <div class="col-md-4 col-sm-4">
                          <article class="aa-blog-content-single">                        
                            <figure class="aa-blog-img">
                              <a href="view_news.php?news_id=<?php echo $row_news['news_id'];?>"><img src="<?=$row_news['pic'];?>"></a>
                            </figure>
                            <p><?php echo $row_news['news_name'];?></p>
                            <div class="aa-article-bottom">
                              <div class="aa-post-date">
                                <i class="fa fa-clock-o"></i> <?php echo date('d/m', strtotime($row_news['news_date']));?>/<?php echo date('Y', strtotime($row_news['news_date']))+543;?>
                              </div>
                            </div>
                          </article>
                        </div>
