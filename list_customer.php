      ...
      <div class="row">
        <div class="col-lg-12">
             ...
             <!-- <div align="right"><a href="register_user.php"><button class="btn btn-success btn-sm" type="button"><i class="fa fa-plus"></i> เพิ่มข้อมูลผู้ใช้งาน</button></a></div>-->
              ...
              <div class="col-xs-12">
                <?php
					$sql_member = "SELECT * FROM tb_member WHERE status = 'MEMBER' ";
					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							<thead>
								<tr>
									...
									<th style="text-align:center; width:10%;">ดูรายการสั่งซื้อ</th>
							...
							<?php
								...
								$sql_order = "SELECT * FROM tb_member WHERE status = 'MEMBER' ";
							...
							<tbody>
								...
								<tr>
									...
									<td style="text-align:center;">
										<a href="view_order.php?id=<?php echo $row_member['id'];?>" class="btn btn-info"><i class="ace-icon fa fa-search"></i> ดูรายการ</a>
									</td>
                                    <!--<td style="text-align:center;">
