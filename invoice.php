										...
										<div class="widget-box transparent">
											<div class="widget-header widget-header-large">
												<h3 class="widget-title grey lighter">
													...
													หมายเลขคำสั่งซื้อ <?php echo $_GET['OrderID'];?>
												</h3>

												<div class="widget-toolbar no-border invoice-info">
													<br>
                                                    <span class="invoice-info-label">วันที่:</span>
													<span class="red"><?php echo date('d/m', strtotime($row_order['OrderDate']));?>/<?php echo date('Y', strtotime($row_order['OrderDate']))+543; ?></span>
												</div>
											</div>
													...
													<div class="row">
														<div class="col-sm-8">
															...
															<div>
																<ul class="list-unstyled spaced">
																	<li>
																		<i class="ace-icon fa fa-caret-right blue"></i> <?php echo $row_mem['full_name'];?> <?php echo $row_mem['last_name'];?>
																	</li>
																	...
																	<li>
																		<i class="ace-icon fa fa-caret-dright blue"></i>
                                                                        <?php
														...
														<div class="col-sm-4">
															<div>
																<ul class="list-unstyled  spaced">
																	<li>
																		<i class="ace-icon fa fa-caret-right green"></i> <?php echo $row_mem['email'];?>
																	</li>

																	<li>
																		<i class="ace-icon fa fa-caret-right green"></i> <?php echo $row_mem['mobile'];?>
																	</li>
																</ul>
															</div>
														</div><!-- /.col -->
														...
														<table class="table table-striped table-bordered">
															...
															?>
																<tr>
                                                                    ...
                                                                    <td style="text-align:center;"><?php echo $row_order_list['Qty'];?></td>
																	<td><div align="right"><?php echo number_format($row_order_list['price'],2);?></div></td>
																</tr>
                                                             <?php
																$num++; }
															 ?>
                                                             	<!--<tr>
                                                                	<td colspan="3" style="text-align:right;"><strong>ค่าจัดส่ง</strong></td>
                                                                    <td style="text-align:right;"><strong><?=number_format($ems,2);?></strong></td>
                                                                </tr>-->
                                                                <tr>
                                                                	<td colspan="3" style="text-align:right;"><strong>รวม</strong></td>
                                                                    <td style="text-align:right;"><strong><?php echo number_format($sumtotal+$ems,2);?></strong></td>
                                                                </tr>
															</tbody>
														</table>
													</div>
