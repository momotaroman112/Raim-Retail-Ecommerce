					...
					<table id="dynamic-table" class="table table-striped table-bordered table-hover">
							...
							<?php
								...
								$sql_order = "SELECT *, sum(price) as sum_order FROM orders 
									...
									WHERE orders.id_member = '".$row_member["id"]."' GROUP by tb_orders.OrderID ORDER by tb_orders.id DESC  ";
								...
								<tr>
									...
									<td style="text-align:center;">
										...
										?>
											...
											<a href="JavaScript:if(confirm('ยืนยันการยกเลิกการสั่งซื้อ?')==true){window.location='<?php echo $_SERVER["PHP_SELF"];?>?can=cancel&id=<?php echo $row_order["id"];?>&OrderID=<?php echo $row_order["OrderID"];?>';}">
