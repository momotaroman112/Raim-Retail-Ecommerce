        ...
        <div class="col-lg-12">
              ...
              <h4 class="form-signin-heading" align="center"></h4>
                  <div class="form-group">
                       <label class="control-label col-sm-3">รายงานประจำเดิอน :</label>
                       <?php $month = array("เลือกเดือน","มกราคม","กุมภาพันธ์","มีนาคม","เมษายน","พฤษภาคม","มิถุนายน","กรกฎาคม","สิงหาคม","กันยายน","ตุลาคม","พฤศจิกายน","ธันวาคม"); ?>
                      <div class="col-sm-5">
                          <select name="mm" class="form-control" required> 
							  <?php foreach ($month as $key=>$val) { ?> 
                                <option value="<?php echo $key?>" <?php echo($key == $m-1) ? 'selected="selected"' : '' ?>><?php echo $val; ?></option> 
                              <?php } ?> 
                            </select> 
                      </div>
                  </div>
                ...
                <?php if($_POST['mm'] != ''){ ?>
                	...
                	รายงานสินค้าขายดี ประจำเดือน <?php echo $month[$_POST['mm']];?>
                    ...
                    <?php
                        $num=1;
                        $sumtotal = 0;
                        $sql_order_list = "SELECT *, SUM(tb_orders.Qty) as sum_qty FROM orders 
							inner join tb_orders on tb_orders.OrderID = orders.OrderID
							WHERE MONTH(orders.OrderDate) = '".$_POST['mm']."' 
							and YEAR(orders.OrderDate) = '".date('Y')."' 
							group by tb_orders.id_product ORDER BY sum_qty DESC  ";
