    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
			  ...
			  ?>
              <form action="update_product_pc.php" class="form-horizontal" role="form" method="post"  enctype="multipart/form-data">
               <input type="hidden" name="id_product" id="id_product" value="<?=$row_product['id'];?>">  
                 <div class="form-group">
                  ...
                  <div class="form-group">
                      <label class="col-sm-2 control-label no-padding-right" for="form-field-2"> ประเภทสินค้า </label>
                      <div class="col-sm-3">
                          <?php
							  $menu = 'SELECT * FROM product_type where protype_status != "C" ORDER BY protype_name ASC ';
							  $st = mysqli_query($conn, $menu);
						  ?>
							  ...
							  <?php while($rmenu = mysqli_fetch_array($st)){ ?>
								  <option value="<?=$rmenu['protype_id'];?>" <?php if($rmenu['protype_id'] == $row_product['protype_id']){echo 'selected'; } ?> ><?=$rmenu['protype_name'];?></option>
							  <?php } ?>
							  </select>
                      </div>
                  </div>
               	  ...
               	  <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="text" name="name_product" id="name_product" placeholder="ชื่อสินค้า" value="<?=$row_product['name_product'];?>" class="form-control" required />
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <label class="col-sm-2 control-label no-padding-right" for="form-field-1-1"> รายละเอียดสินค้า </label>
                          ...
                          <textarea class="area-full" rows="5" name="detail_product"><?=$row_product['detail_product'];?></textarea>
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      <label class="col-sm-2 control-label no-padding-right" for="form-field-2"> ราคา:หน่วย </label>

                      <div class="col-sm-3">
                          <input type="number" placeholder="0.00" name="price" class="col-xs-10 col-sm-5 form-control" value="<?=$row_product['price'];?>" required />
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-3">
                          <input type="number" placeholder="0.00" name="amount" class="col-xs-10 col-sm-5 form-control" value="<?=$row_product['amount'];?>" required />
                      </div>
                  </div>
                  ...
                  <div class="form-group">
					  ...
					  <div class="col-sm-4">
                          ...
                          <input type="hidden" name="hdnOldFile" value="<?=$row_product['pic'];?>">
						  <input type="file" id="input-dim-1" accept="image/*" name="file_product"  OnChange="showPreview(this)" ><span class="ace-file-container" data-title="เลือกไฟล์ภาพ"><span class="ace-file-name" data-title="No File ..."></span></span>
