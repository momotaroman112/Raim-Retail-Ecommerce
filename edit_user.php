   ...
   <div class="container">
     <div class="row">
       <div class="col-md-12">
		...
		?>
          <form action="update_edit_user.php" method="post" enctype="multipart/form-data" onSubmit="return fncSubmit(this);">
                      ...
                      <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            ...
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                 <select id="provinces" name="provinces" class="form-control" required onchange="data_show(this.value,'amphures','');document.getElementById('districts').innerHTML = '<option value=>-- เลือกอำเภอ --</option>';">
                                      ...
                                      {
                                      ?>
                                      <option value="<?php echo $objResultg["PROVINCE_ID"];?>" <? if($objResultg['PROVINCE_ID'] == $row_member['provinces']){echo 'selected'; } ?> ><?php echo $objResultg["PROVINCE_NAME"];?></option>
                                      <?php
                                      }
                                      ?>
                                  </select>
                          ...
                          <div class="row">
                            ...
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <input type="text" name="mobile" id="mobile" placeholder="เบอร์ติดต่อ" OnKeyPress="return chkNumber(this)" maxlength="10" value="<?php echo $row_member["mobile"];?>" required>
                              </div>
                            </div>
                            <div class="col-md-6">
                              <div class="aa-checkout-single-bill">
                                <select name="status" id="status" required>
                                    <option value="USER" <? if($row_member['status'] == 'USER'){echo 'selected';} ?>>พนักงาน</option>
                                    <option value="ADMIN" <? if($row_member['status'] == 'ADMIN'){echo 'selected';} ?>>ผู้ดูแลระบบ</option>
                                </select>
                              </div>
                            </div>
                         </div>   
              ...
              <div class="col-md-6">
                <div class="checkout-right">
                  ...
                  <?php if($row_member['pic'] != ''){ ?>
                    <img src="<?=$row_member['pic'];?>">
                  <?php }else{ ?>
                    <img src="img/user.png" width="350">
                  <?php } ?>
                  </div>
                </div>
              </div>
