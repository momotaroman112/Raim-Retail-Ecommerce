   ...
   <div class="container">
     <div class="row">
       <div class="col-md-12">
		...
		?>
          <form action="add_register.php" method="post" enctype="multipart/form-data" onSubmit="return fncSubmit(this);">
          <input type="hidden" name="id_member" value="<?=$_SESSION['id_member'];?>">
            <div class="row">
            <div align="center"><h2>สมัครสมาชิก</h2></div>
                    ...
                    <div class="panel panel-default aa-checkout-billaddress">
                      ...
                      <div id="collapseOne" class="panel-collapse collapse in">
                        <div class="panel-body">
                            ...
                            <div class="col-md-12">
                              <div class="aa-checkout-single-bill">
                                <input type="password" name="pass" id="pass" placeholder="รหัสผ่าน" required>
                              </div>
                            </div>
                          </div> 
                         	<div class="row">
                          ...
                          <input type="submit" value="สมัครสมาชิก" class="aa-browse-btn" />
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <!--<div class="col-md-4">
                <div class="checkout-right">
                  ...
                  <div class="aa-order-summary-area">
                    <img src="img/login.jpg" style="width:50%;">
                  </div>
                </div>
              </div>-->
            </div>
