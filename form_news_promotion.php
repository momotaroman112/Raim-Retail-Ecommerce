    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
              ...
              <div class="col-xs-12">
              <form method="post" action="add_promotion.php" class="form-horizontal" enctype="multipart/form-data">
              <h4 class="form-signin-heading" align="center"></h4>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-5">
                          <textarea name="promotion_detail" class="area-full" rows="10"></textarea>
                      </div>
                  </div>
                  <div class="form-group">
                       <label class="control-label col-sm-3">วันเขตวันที่ :</label>
                      <div class="col-sm-5">
                          <input type="date" class="form-control" name="promotion_end" min="<?=date('Y-m-d');?>" required>
                      </div>
                  </div>
                  <div class="form-group">
