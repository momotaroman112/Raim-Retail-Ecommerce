                ...
                <?
					$perpage = 12;
					 ...
					 $start = ($page - 1) * $perpage;
						...
						$sql_order = "SELECT * FROM tb_orders where tb_orders.SID = '".session_id()."'";
							...
							if($_GET[id_product] != ''){
								if($menu != '5' && $menu != '10'){
									$sql_product = "SELECT * FROM tb_orders 
										inner join product_detail_join on tb_orders.id_product = product_detail_join.product_id
										inner join product_detail on product_detail.id = product_detail_join.product_join
										where product_detail.protype_id = '".$menu."' and tb_orders.SID = '".session_id()."'";
										//echo $sql_product.'44444444444444' ;
								}else{
								...
								$sql_product = "SELECT * FROM tb_orders 
										inner join product_detail_join on tb_orders.id_product = product_detail_join.product_id
										inner join product_detail on product_detail.id = product_detail_join.product_join
										where product_detail_join.type_join = '".$menu."' and tb_orders.SID = '".session_id()."'";
							}
						}else{
							$sql_product = "SELECT * FROM product_detail WHERE protype_id = '".$menu."' AND product_detail.status != 'C' ORDER BY id DESC limit {$start} , {$perpage}  ";
						}
            ...
            <div class="aa-sidebar-widget">
              ...
              <?
				...
				while($rmenu = mysql_fetch_array($st)){
					...
					$sql_orderm = "SELECT * FROM tb_orders where tb_orders.SID = '".session_id()."' and protype_id = '$row_ty[protype_id]' ";
