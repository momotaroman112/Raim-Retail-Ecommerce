       ...
       <div class="col-md-12">
        ...
        <?php
			if(isset($_SESSION["id_member"]) != ''){
				$user_id = $_SESSION['id_member'];
			}else{
				$user_id = '';
			}
			$sql = "SELECT * FROM tb_member WHERE id = '".$user_id."' ";
			$smt = mysqli_query($conn, $sql) or die ("Error Query [".$sql."]");
			$row = mysqli_fetch_array($smt);
			
		?>
          <form action="add_mem_add.php" method="post" enctype="multipart/form-data" onSubmit="return fncSubmit(this);">
