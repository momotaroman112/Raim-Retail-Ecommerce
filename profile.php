      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="aa-blog-comment-threat">
			<?php
				if($_GET['member'] != ''){
					$sql_member = "SELECT * FROM tb_member WHERE id = '".$_GET['id_member']."' ";
				}else{
			...
			?>
              ...
              <br><br><br>
                <table class="table table-bordered">
                  <tr>
                  	<td colspan="2"><strong>ข้อมูลส่วนตัว</strong></td>
                  </tr>
                  <tr>
                    <td style="width:50%;">
                        ชื่อ-นามสกุล : <?=$row_member['full_name'];?> <?=$row_member['last_name'];?><br><br>
                        เบอร์โทรศัพท์ : <?=$row_member['mobile'];?> <br><br>
                        อีเมล : <?=$row_member['email'];?>
                    </td>
                    ...
                    <td style="text-align:center;">
                        ...
                        <?php }else{ ?>
                        <img src="<?=$row_member['pic'];?>" width="150" />
                        <?php } ?>
                    </td>
                  </tr>
                </table>
              <br>
                <table class="table table-bordered">
                  <tr>
                  	<td><strong>ที่อยู่ในการจัดส่ง</strong></td>
                  </tr>
                  <tr>
                    <td>
                       <?php
                ...
                <div align="center"><a href="edit_profile_mem.php?id_member=<?=$row_member['id'];?>" class="btn btn-warning btn-sm">แก้ไขข้อมูล</a></div>
                <br><br><br>
