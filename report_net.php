        ...
        <div class="col-lg-12">
              ...
              <h4 class="form-signin-heading" align="center"></h4>
                ...
                <?php if($_POST['start_date'] != ''){ ?>
                	...
                	รายงานยอดขายสินค้า วันที่ <?php echo date('d/m/Y', strtotime($_POST['start_date']));?> ถึงวันที่ <?php echo date('d/m/Y', strtotime($_POST['end_date']));?>
                    ...
                    <?php
                        ...
                        $sql_order_list = "SELECT * FROM orders 
							...
							WHERE DATE(orders.OrderDate) BETWEEN '".$_POST['start_date']."' and '".$_POST['end_date']."' and orders.status_pay = 'Y'  ";
