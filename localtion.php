   ...
   // conndb();
	...
	$em = $_GET['em'];
         ...
         if ($data=='provinces') { 
              ...
              $result=mysqli_query($conn, "select * from provinces order by PROVINCE_NAME");
         ...
         <?php
              ...
              $result=mysqli_query($conn, "SELECT * FROM amphures WHERE PROVINCE_ID = '$val' ORDER BY AMPHUR_NAME");
              while($row = mysqli_fetch_array($result)){
        ?>
        ...
        <?php
              ...
              $result=mysqli_query($conn, "SELECT * FROM districts WHERE AMPHUR_ID= '$val' ORDER BY DISTRICT_NAME");
              while($row = mysqli_fetch_array($result)){
              ...
              $result=mysqli_query($conn, "SELECT * FROM zipcodes WHERE district_code = '$val' ORDER BY zipcode");
              while($row = mysqli_fetch_array($result)){
