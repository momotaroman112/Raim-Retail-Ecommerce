  ...
  <section id="aa-product-category">
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
              <br><br><br>
              <h3>รายงานยอดขายสินค้า</h3>
              <div class="col-xs-12">
                
                <?php if($_GET['start_date'] != ''){ ?>

                	รายงานยอดขายสินค้า วันที่ <?php echo date('d/m/Y', strtotime($_GET['start_date']));?> ถึงวันที่ <?php echo date('d/m/Y', strtotime($_GET['end_date']));?>
                    ...
                    <?php
                        $num=1;
                        $sumtotal = 0;
                        $sql_order_list = "SELECT *, SUM(tb_orders.price) as sum_pro FROM tb_orders 
							inner join product_detail on product_detail.id = tb_orders.id_product
							WHERE DATE(tb_orders.OrderDate) BETWEEN '".$_GET['start_date']."' and '".$_GET['end_date']."' and tb_orders.status_pay = 'Y' group by tb_orders.id_product  ";
                        ...
                        while($row_order_list = mysqli_fetch_array($st_order_list)){
                            ...
                            $sumtotal += $row_order_list['sum_pro'];
                    ...
                    ?>
                        <tr>
                            ...
                            <td><div align="right"><?php echo number_format($row_order_list['sum_pro'],2);?></div></td>
                        </tr>
                     <?php
                        $num++; }
                     ?>
                        <tr>
                            ...
                            <td style="text-align:right;"><strong><?php echo number_format($sumtotal,2);?></strong></td>
                        </tr>
                    </tbody>
                </table>
                <?php } ?>
