              ...
              <form action="add_product_pc.php" class="form-horizontal" role="form" method="post"  enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                      <label class="col-sm-2 control-label no-padding-right" for="form-field-2"> รหัสสินค้า </label>
						 <?php 
					   $sql = "SELECT id FROM product_detail order by id DESC LIMIT 1";  
					   $stt = mysqli_query($conn, $sql);
					  ?>
						  <?php while($rmenu = mysqli_fetch_array($stt)){ ?>
						  ...
						  $b = substr($iddetail, 4);
						   ...
						   ?>
                      <div class="col-sm-3">
                          <input type="text" name="code_product" id="code_product" value="<?php  echo $a,$b+1;?>" placeholder="รหัสสินค้า" class="col-xs-10 col-sm-5 form-control" readonly />
                      </div>
                  </div>
                  ...
                  <div class="form-group">
               	  ...
               	  <div class="form-group">
                      ...
                      <div class="col-sm-6">
                          <input type="text" name="name_product" id="name_product" placeholder="ชื่อสินค้า" class="form-control" required />
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-3">
                          <input type="number" placeholder="0.00" name="price" class="col-xs-10 col-sm-5 form-control" required />
                      </div>
                  </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-3">
                          <input type="number" placeholder="0.00" name="amount" class="col-xs-10 col-sm-5 form-control" required />
                      </div>
                  </div>
